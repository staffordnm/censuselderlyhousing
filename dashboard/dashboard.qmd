...
#get county data
nc_counties <- tigris::counties("NC", cb = TRUE, year = 2020)
...
map1 <- ggplot() +
  ...
  theme(panel.grid = element_blank(),
        ...
        plot.margin = margin(t = 7, r = 15, b = 0, l = 0))
#map 2 ------
map2 <- ggplot() +
  ...
  theme(panel.grid = element_blank(),
        ...
        legend.box = "horizontal",
        plot.title = element_text(hjust = 0.5, face = "bold"), 
        plot.margin = margin(t = 7, r = 0, b = 0, l = 15))
...
patchwork + plot_annotation(
  title="Housing Burden Among Ages 55+ in NC Central Pines Regional Council Area", 
  subtitle = "Housing Burden is highest in parts of Wake and Durham Counties",
  theme = theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 20), plot.subtitle = element_text(hjust = 0.5, vjust = -2)))
```
