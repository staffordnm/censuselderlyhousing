...
-   Start by downloading and saving the 'ACSPUMS1Y2021_all_counties.csv' file from the /data folder on my github /censuselderlyhousing repository. Save to a local folder called "data".

-   Open the dashboard.qmd file in the /dashboard folder on my github /censuselderlyhousing repository.
