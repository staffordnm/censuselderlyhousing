...
Following the presentations we made, we made changes on the population bar chart and the dot plots on race taking feedback and moving the legend to the bottom of the charts. We also added in the scale for the values on the y-axis.
